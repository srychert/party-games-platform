...
>>>>>>> 9b46bb83bd8445ffdb329f73a18260749c31c86d
  ...
  return (
    <div className="new-game">
      {!connected && <form>
        ...
        <button type="submit" onClick={(e) => HanldeSubmit(e)}>Dołącz do gry</button>
      </form>}
      {connected &&
        <div style={{ display: "flex", flexDirection: "column" }}>
          <label htmlFor="msg">Wiadomość</label>
          <input type="text" name="msg" id="msg" value={msg} onChange={(e) => setMsg(e.target.value)}></input>
